...
<head>
   ...
   <div  id=container>
   <form action="${home }job/add" onsubmit="return sndFrm();" method=post id="frm">
      <div id=left_box>            
         <div class="map_wrap">
             ...
             <div align="left">                   
                <table>
                  ...
                  <tr>
                     ...
                     <td><input id="spinner" name="job_num" style="width:20px;">   </td>      
                  </tr>
                  <tr>
                     <td><br></td>
                  </tr>
                  ...
                  <tr>
                     ...
                     <td><input type="text" placeholder="날짜를 입력해 주세요." name="job_date" id="datepicker" style="height:30px;"></td>
                  </tr>
                  <tr><td><br></td></tr>
                  <tr>
                     <td align="left"><h4>시간</h4></td>
                     <td>
                        <input type="text" name="job_time_start" style="width:80px;height:30px;">~
                        <input type="text" name="job_time_end" style="width:80px;height:30px;">
                     </td>
                  </tr>
                  <tr>
                  </tr>
      ...
      <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=11b5c8e67235051a9e05cc5d09d8f60a&libraries=services"></script>   
