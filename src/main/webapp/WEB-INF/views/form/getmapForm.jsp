...
<div>
   ...
   <input type="button" onclick="searchAddr();return false;" value="검색">
   <input type="button" onclick="sendToParent();" value="확인" >
</div>

<script>      
function sendToParent(){
	var txt = document.getElementById("road_address").value.split(" ");
    opener.document.getElementById("reciaddr").value = txt[0]+" "+txt[1];
    window.close();
}
