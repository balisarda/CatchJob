...
<center>
	...
	<input type="hidden" name="notice_idx" value="${noticeLst.notice_idx }">
		<table style="width: 650px;">
			<tr>
				<td style="width: 80px; height: 40px;" align="left">제 목
				</td>
				<td style="width: 570px; height: 40px;">
					<input type=text name='notice_title' value="${noticeLst.notice_title }"/><a style="color: red;">${msg }</a>
				</td>
				<td align="right">${noticeLst.notice_idx }</td>
			</tr>
			<tr>
				<td colspan=2 align="right">
				<textarea name="notice_contents"  
				style="width: 650px; height: 300px">${noticeLst.notice_contents }</textarea>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<input type=button value='목록' style="width: 80px;" onclick="location.href='${home }board/noticeSelectProc'"/></td>
			</tr>
		</table>
	</form>
</center>