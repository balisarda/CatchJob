...
<form action="${home }board/writeProc" method="post">
	...
	<br>
	<div>
		<a onMouseover="this.style.color='red';"><b>한 줄 소개 제목</b></a> <input type="text" name="board_title"
			placeholder="나를 한마디로?" maxlength="20" size="25" /> <a
			style="color: red; padding:10px">${msg }</a>
	</div>
	<br>
	<hr>
	<div>
		<!-- 하고 싶은 알바 유형 -->
		<br> <a onMouseover="this.style.color='blue';"><b>하고 싶은 알바 유형</b></a> <br> <br> <input
	...
	<div>
		...
		<div>
			<a onMouseover="this.style.color='blue';"><b>평일</b></a> <input type="checkbox" name="board_time" value="평일 오전">평일
			오전 <input type="checkbox" name="board_time" value="평일 오후">평일
			오후 <input type="checkbox" name="board_time" value="평일 밤">평일 밤
			오후 <br>
		</div>
		<div>
			<a onMouseover="this.style.color='blue';"><b>주말</b></a> <input type="checkbox" name="board_time" value="주말 오전">주말
	...
	<div>
		...
		<div>
			<input type="button" class="btn-gradient red mini" onclick="SearchAddr('${home}form/getmapForm')"
