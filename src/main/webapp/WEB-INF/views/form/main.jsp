...
<link rel="stylesheet" href="${css }main.css" >
		...
		<div style="height: 500px; padding: 5px, 17px, 13px, 0px; margin-top: 100px; margin-left: 300px;">
			...
			<div style="background-color: #2ce71c; color: #FFFFFF; display: block; width: 350px; float: left; margin-top: 2px; margin-right: 15px; margin-bottom: 2px; margin-left: 0px;">
