/**
 * Kakao Javascript SDK for Kakao Open Platform Service - v1.17.1
 *
...
(function (f) {
  ...
  var define, module, exports;return function e(t, n, r) {
    function s(o, u) {
      ...
      module.exports = function () {
        ...
        function _loginThroughTalk(settings, stateToken) {
          ...
          _poller.start(function () {
            ...
            handleAuthResponse({ error: "timeout", description: "login timeout. retry." }, settings);
      ...
      module.exports = function () {
        ...
        function defaultRequest(settings, callerMsg) {
          ...
          if (templateObject.object_type == 'text') {
            templateObject['text'] = settings.text || '';
          }
    ...
    }, { "../vendor/web2app.js": 25, "./common.js": 8, "./link.obj.js": 15, "./util.js": 19, "./webviewchecker.js": 20 }], 15: [function (require, module, exports) {
      /*******************
       * Link Object
       *******************/
      module.exports = function () {
